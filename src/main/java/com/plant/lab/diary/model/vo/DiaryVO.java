...
public class DiaryVO {
	...
	public DiaryVO(int diary_no, int diary_write, String diary_content, Date diary_date, int diary_views, int diary_img_num,
			String diary_img_src, String user_id, int user_no) {
	...
	public String toString() {
		return "DiaryVO [diary_no=" + diary_no + ", diary_write=" + diary_write + ", diary_content=" + diary_content
				+ ", diary_date=" + diary_date + ", diary_views=" + diary_views + ", diary_img_num=" + diary_img_num + ", diary_img_src="
				+ diary_img_src + ", user_id=" + user_id + ", user_no=" + user_no + "]";
	}
