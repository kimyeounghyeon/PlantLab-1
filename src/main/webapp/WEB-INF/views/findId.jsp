...
<header>
  ...
  <form method="post" class="loginFrm" action="find_id" name="findform">
		<section class="login-wrap">
			<div class="login-id-wrap">
				<input placeholder="이름" type="text" class="input-id" name="userName" required/>
			</div>
			<div class="login-pw-wrap">
				<input placeholder="핸드폰" type="text" class="input-pw"
					name="phone" required/>
			</div>
		...
		<section class="find-signup-wrap">
		 <span class="find-pw"> <a href="<%=request.getContextPath()%>/find_password_form" target="_blank"
